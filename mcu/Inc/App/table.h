...
typedef enum
{
	...
	TABLE_IDX_INNER_GIMBAL_ANGLE = TABLE_IDX_OUTER_GIMBAL_ANGLE + sizeof(float),
	TABLE_IDX_ZERO_REF_OUTER_GIMBAL = TABLE_IDX_INNER_GIMBAL_ANGLE + sizeof(float),
	TABLE_IDX_ZERO_REF_INNER_GIMBAL = TABLE_IDX_ZERO_REF_OUTER_GIMBAL + sizeof(float),
	MAX_TABLE_IDX = TABLE_IDX_ZERO_REF_INNER_GIMBAL + sizeof(float)
}idx_t;
